...
settings_parser.add_argument('-x_range_title',type=str,nargs=1,metavar='str',default='Radius (10^3 km)',help='The text below the x axis')
settings_parser.add_argument('-y_range_title',type=str,nargs=1,metavar='str',default='Radius (10^3 km)',help='The text to the left of the y axis')
